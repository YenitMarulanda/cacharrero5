...
//        crudRepository.saveAll(List.of(new Clone("AP-903", "ACME", "MATERIAL 1", "PRESENTACION 1", "DESCRIPCION DETALLADA", true, 120000, 10, "https://www.avasoluciones.com/uploads/2021/09/910-006127.jpg"),
//                new Clone("AP-904", "ACME", "MATERIAL 2","PRESENTACION 2", "DESCRIPCION DETALLADA",  true, 130000, 10, "https://www.avasoluciones.com/uploads/2021/09/910-007.jpg")
//        ));
...
//        Map<String, Clone> productOrderOne = new HashMap<String, Clone>();
//        Map<String, Clone> productOrderTwo = new HashMap<String, Clone>();
//
